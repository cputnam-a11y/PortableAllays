...
public record AllayPickupPayload(UUID uuid) implements CustomPayload {
    static final Id<AllayPickupPayload> ID = new Id<>(Identifier.of(PortableAllays.MOD_ID, "allay_pickup"));
    static final PacketCodec<PacketByteBuf, AllayPickupPayload> CODEC = PacketCodec.ofStatic(AllayPickupPayload::write, AllayPickupPayload::_new);
